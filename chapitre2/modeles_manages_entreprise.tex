...
Cette organisation ne supprime pas les risques. Elle exige une gestion rigoureuse des secrets, des permissions, des journaux et des indisponibilités. Microsoft recommande l'authentification par Microsoft Entra ID pour les connexions sans clé ; lorsque des clés API sont utilisées, elles doivent rester gérées comme des secrets et protégées hors du code applicatif \cite{azure-entra-auth,azure-key-vault-secrets}.
