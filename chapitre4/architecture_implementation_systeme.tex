...
Les deux déclinaisons ne possèdent pas le même niveau de maturité. Java/Spring Boot constitue la référence la plus avancée, avec un processus complet, une réparation gouvernée, un assistant et un reporting. Angular est en développement actif : les agents principaux sont implémentés et la trajectoire progressive 11--21 est engagée, avec des stages scellés jusqu'à Angular~16 dans la dernière preuve technique intégrée au rapport. Le texte distingue donc les fonctionnalités validées, partielles et encore à consolider.
...
Pour Angular, une migration manuelle d'Angular 18 vers 20 a d'abord été réalisée afin de comprendre les transformations, puis la Factory a été étendue à une trajectoire 11--21. Les agents d'analyse, de révision, de planification et de transformation sont développés. Les preuves techniques retenues établissent des stages scellés jusqu'à Angular~16 ; le passage 16 vers 17 reste non scellé et le processus complet jusqu'à Angular~21 demeure en validation.
