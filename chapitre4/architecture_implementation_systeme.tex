...
Afin de documenter l'interface sans transformer ce chapitre en galerie d'écrans, quatre vues représentatives ont été retenues : deux pour Angular et deux pour Java/Spring Boot. Elles illustrent respectivement la préparation d'une migration, la supervision d'une phase agentique, la qualification de l'environnement Java et l'examen d'une réparation gouvernée.
...
Cette capture est utilisée pour documenter le comportement de l'interface de supervision et la séparation des rôles. Les libellés de fournisseur ou de modèle visibles dans l'écran ne sont pas utilisés, à eux seuls, comme preuve du fournisseur LLM effectivement validé pour la déclinaison Angular.
