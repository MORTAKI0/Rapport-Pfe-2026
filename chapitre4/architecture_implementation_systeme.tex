...
\begin{figure}[H]
    ...
    \IfFileExists{figures/chapitre4/angular-demo-a1.png}{%
        ...
        \fbox{\parbox[c][5cm][c]{0.9\textwidth}{\centering\bfseries Capture Angular A1 à intégrer\\\normalfont Jalon du planning initial ; non utilisé comme preuve technique dans ce rapport.}}%
    }
